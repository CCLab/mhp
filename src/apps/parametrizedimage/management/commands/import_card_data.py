    ...
    def handle(self, *args, **kwargs):
        with open(DATA_FILE_NAME) as csv_file:
            parameter_attribute_names = {
                ...
                'karta': None,
                'data badania': None,
                'Ob. stopy na Met.': None, # ???
            }


            unused_parameters = {
                'Front.-Front.': 'szerokosc_czola',
                'Zyg.-Zyg.': 'szerokosc_twarzy',
                'Gon.-Gon.': 'szerokosc_zuchwy',
                'Ob. Głowy': 'obwod_glowy',
                'Ob. szyi': 'obwod_szyi',
                'Ob. Piersi': 'obwod_piersi',
                'Ob. w pasie': 'obwod_w_pasie',
                'Ob. na lliosp.': 'obwod_bioder',
                'Ob. na Trochan.': 'obwod_posladkow',
                'Najw. ob. ram.': 'najwiekszy_obwod_ramienia',
                'Najw. ob. przedr.': 'najwiekszy_obwod_przedramienia',
                'Najm. ob. przedr.': 'najmniejszy_obwod_przedramienia',
                'Najw. ob. Uda': 'najwiekszy_obwod_uda',
                'Ob. Kolana': 'parameter_obwod_kolana',
                'Najw. ob. przedudzi.': 'parameter_najwiekszy_obwod_przedudzia',
                'Najmn. ob. przedudzi.': 'parameter_najmniejszy_obwod_przedudzia',
                'Ob. podbicia górn.': 'parameter_obwod_podbicia_gornego',
                'Ob. podbicia doln.': 'parameter_obwod_podbicia_dolnego',
            }
            ...
            for item in reader:
                ...
                for card_parameter in CARD_PARAMETERS:
                    if card_parameter['csv_field_name'] not in column_ids:
                        continue
